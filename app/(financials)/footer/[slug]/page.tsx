  ...
  return (
    <section className="relative max-container padding-container mt-24">
      <div className="h-full flex flex-col justify-center items-start gap-4">
        ...
        <h1 className="bold-32 text-orange-base max-w-3xl lg:bold-56 items-center">
          {page?.title}
        </h1>
        {page?.description && <div className="regular-18" dangerouslySetInnerHTML={{ __html: page?.description }} />}
      </div>
    </section>
  )
}
