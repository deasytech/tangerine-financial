    ...
    <>
      <section className="relative max-container padding-container flex flex-col gap-12 md:flex-row items-start w-full mt-44">
        <div className="w-full space-y-3 flex-[2]">
          <BackWithBreadCrumbs page="Group Life Assurance" textTheme="text-green-500" />
          <h1 className="bold-56 text-green-900">Group Life Assurance Scheme</h1>
        ...
        <div className="w-full flex-[3]">
          <Image src="/images/life/group-life-banner.png" alt="group life assurance" width={696} height={364} className="w-full object-contain" />
        </div>
      </section>
