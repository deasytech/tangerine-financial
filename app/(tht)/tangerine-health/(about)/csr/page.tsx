  ...
  return (
    <>
      <section className="relative max-container padding-container flex flex-col gap-12 justify-center items-center w-full mt-44">
        <div className="w-full space-y-3 text-center flex flex-col justify-center">
          <h1 className="bold-48 text-blue-950">Corporate Social Responsibility</h1>
          <Image src="/images/tht/csr-banner.png" alt="CSR" width={598} height={393} className="w-full h-auto py-10" />
          <div className="w-full bg-orange-base max-w-3xl p-10 space-y-3 rounded-3xl">
