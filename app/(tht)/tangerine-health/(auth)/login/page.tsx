  ...
  return (
    <section className='relative max-container padding-container mt-20'>
      ...
      <div className="text-center mb-12 mt-6">
        <Link href="/tangerine-health/register" className="bg-blue-50 py-2 px-6 rounded-full regular-12 text-blue-950">Don't have an account? <span className="!font-gilroy-bold">Register here</span></Link>
      </div>
        ...
        <div className="w-full max-w-3xl grid grid-cols-2 md:grid-cols-4 gap-4 justify-center">
          {HEALTH_PLANS.map((plan) => (
            <div key={plan.text} className="text-center w-full">
              <Link href={`/tangerine-health/${plan.link}`}>
