...
const Hero = () => {
  return (
    <section className="relative max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row h-[600px]">
      <div
      ...
      <div className="relative z-10 flex flex-col items-start max-w-[800px]">
        <h1 className="bold-32 mt-36 lg:bold-72 lg:mt-10">
